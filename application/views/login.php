...
<html lang="en">
    ...
    <body class="bg-gradient-info" style='background-image: url(<?= base_url('assets/')?>img/jagung2.jpg);'>
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-info" style="font-weight: 900;" href="<?= base_url('')?>"> <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pendukung Keputusan</a>
            </div>
        </nav>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">SPK MOORA Bibit Varietas Unggul Jagung Terbaik</h4>
                            <p class="pt-4">
                ...
                <div class="col-xl-5 col-lg-5 col-md-5 mt-5">
                    ...
                    <!-- <div class="card bg-light mb-3" style="max-width: 30rem;">
                        <div class="card-body text-justify">
                            ...
                            <p class="card-text" >untuk user atau petani dapat memasukkan username "user" dan password "user" untuk dapat masuk kedalam sistem</p>
                        </div>
                    </div> -->
                </div>
