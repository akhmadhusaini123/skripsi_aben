			...
			<div class="row">
				...
				<div class="form-group col-md-12">
					...
					<select name="jenis" class="form-control" id="jenis" required>
						...
						<option value="Komposit" <?php if ($alternatif->nama == "Komposit"){echo "selected";} ?>>Komposit</option>
						<option value="Hibrida" <?php if ($alternatif->jenis == "Hibrida"){echo "selected";}?>>Hibrida</option>
					</select>
				</div>
			</div>
		</div>
