				...
				<tbody>
					...
					<tr align="center">
						...
						foreach($kriterias as $kriteria):
							...
							$id_kriteria = $kriteria->id_kriteria;
							echo '<td>';
							echo round($matriks_r[$id_kriteria][$id_alternatif],3);
							echo '</td>';
						endforeach;
						?>
					</tr>
				...
				<tbody>
					...
					<tr align="center">
						...
						foreach($kriterias as $kriteria):
							...
							$id_kriteria = $kriteria->id_kriteria;
							echo '<td>';
							echo round($matriks_rb[$id_kriteria][$id_alternatif],3);
							echo '</td>';
						endforeach;
						?>
					</tr>
				...
				<tbody>
					...
					<tr align="center">
						...
						foreach($kriterias as $kriteria):
							$id_alternatif = $alternatif->id_alternatif;
							$id_kriteria = $kriteria->id_kriteria;
							$nilai_rb = round($matriks_rb[$id_kriteria][$id_alternatif],3);
							if ($kriteria->jenis=="Benefit"){
								$total_max += $nilai_rb;
							}else{
								$total_min += $nilai_rb;
